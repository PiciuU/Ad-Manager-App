<template>
    <el-dialog :model-value="true" title="Edycja danych użytkownika" :lock-scroll="true" :before-close="closeModal" :close-on-click-modal="!isLoading" :close-on-press-escape="!isLoading">
